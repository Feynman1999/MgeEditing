...
class Bottleneck(M.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1):
        ...
        self.bn1 = M.BatchNorm2d(bottle_planes, momentum=BN_MOMENTUM)
        ...
        self.bn2 = M.BatchNorm2d(bottle_planes, momentum=BN_MOMENTUM)
        self.conv3 = M.Conv2d(bottle_planes, planes, kernel_size=1, bias=False)
        self.bn3 = M.BatchNorm2d(planes, momentum=BN_MOMENTUM)
        self.relu = M.ReLU()
        self.stride = stride
...
class Root(M.Module):
    def __init__(self, in_channels, out_channels, kernel_size, residual):
        ...
        self.bn = M.BatchNorm2d(out_channels, momentum=BN_MOMENTUM)
        self.relu = M.ReLU()
    ...
    def __init__(self, levels, block, in_channels, out_channels, stride=1, level_root=False, root_dim=0, root_kernel_size=1,
        ...
        if in_channels != out_channels:
            self.project = M.Sequential(
                ...
                M.BatchNorm2d(out_channels, momentum=BN_MOMENTUM)
            )
    ...
    def _make_conv_level(self, inplanes, planes, convs, stride=1, dilation=1):
        ...
        for i in range(convs):
            modules.extend([
                ...
                M.BatchNorm2d(planes, momentum=BN_MOMENTUM),
                M.ReLU()])
            inplanes = planes
...
class DeformConv(M.Module):
    def __init__(self, chi, cho):
        ...
        self.actf = M.Sequential(
            M.BatchNorm2d(cho, momentum=BN_MOMENTUM),
            M.ReLU()
        )
        channels_ = 3 * 3 * 3
