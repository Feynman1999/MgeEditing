...
class SIAMFCPP_one_insnorm_deform(M.Module):
    def __init__(self, in_cha,
        ...
        super(SIAMFCPP_one_insnorm_deform, self).__init__()
        self.in_cha = in_cha
...
class AlexNet_stride4(M.Module):
    ...
    def forward(self, x):
        ...
        x = x + self.lrelu(self.conv2(x, offset2, mask2))  # 8,28,256,256
        ...
        x = x + self.lrelu(self.conv4(x, offset4, mask4))  # 8,28,256,256
