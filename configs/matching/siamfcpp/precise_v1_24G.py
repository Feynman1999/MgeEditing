...
train_pipeline = [
    ...
    dict(type='ColorJitter', keys=['opt', 'sar'], brightness=0.2, contrast=0.5, saturation=0.0, hue=0.0),
    # dict(type='Add_contrast', keys=['opt', 'sar'], value = 1), # [0~1]
    ...
    # dict(type='FramesToTensor', keys=['opt', 'sar', 'bbox']),  # [H,W,C] -> [3,C,H,W]
...
# optimizer
optimizers = dict(generator=dict(type='Adam', lr=0.6 * 1e-3, betas=(0.9, 0.999), weight_decay=5e-5)) # 1 -> 0.4 
...
load_from = None # f'./workdirs/{exp_name}/20210106_173454/checkpoints/epoch_430'  # f'./workdirs/{exp_name}/20210106_001537/checkpoints/epoch_900' # f'./workdirs/{exp_name}/20210101_225424/checkpoints/epoch_20' # f'./workdirs/{exp_name}/epoch_70' # f'./workdirs/{exp_name}/20201121_002958/checkpoints/epoch_100'
resume_from = None
resume_optim = True
workflow = 'train'
