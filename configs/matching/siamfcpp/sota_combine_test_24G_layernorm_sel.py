exp_name = 'combine_test'
load_from = "/data/home/songtt/chenyuxiang/MBRVSR/workdirs/epoch_1"
dataroot = "/data/home/songtt/chenyuxiang/datasets/stage2"
file_list_name = "valid_img_list_path.txt"
#############################################################
...
# optimizer
optimizers = dict(generator1=dict(type='Adam', lr=1e-9, betas=(0.9, 0.999), weight_decay=2e-6),
                  generator2=dict(type='Adam', lr=1e-9, betas=(0.9, 0.999), weight_decay=2e-6))
