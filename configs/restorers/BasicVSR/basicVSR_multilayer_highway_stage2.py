load_from = "./workdirs/basicVSR_multi_layer_highway_stage1/20210413_005209/checkpoints/epoch_4"
path2spynet = "./workdirs/spynet/spynet-sintel-final.mge"
dataroot = "/work_base/datasets/REDS/train"
exp_name = 'basicVSR_multi_layer_highway_stage2'
is_shift = False
blocktype = "resblock"
...
# optimizer
optimizers = dict(generator=dict(type='Adam', lr=3 * 1e-4, betas=(0.9, 0.999),
