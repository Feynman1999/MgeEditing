...
exp_name = 'basicVSR_multi_layer_shift_stage1'
batchsize = 2
is_shift = True
...
# optimizer
optimizers = dict(generator=dict(type='Adam', lr= batchsize * 1.0 * 1e-4, betas=(0.9, 0.999),
...
evaluation = dict(interval=10000000, save_image=False, multi_process=False, ensemble=False)
# 测试时100帧不能同时upsample
