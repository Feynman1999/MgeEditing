...
eval and test:  25帧滑动 每一帧最多算两次

"""
load_from = "./workdirs/optical_flow_transformer/20210421_224224/checkpoints/epoch_70"
...
train_cfg = dict(img_norm_cfg = img_norm_cfg, train_cfg = dict(viz_flow = True))
...
train_pipeline = [
    dict(type='GenerateFrameIndices', interval_list=[2], many2many = True, index_start = 0, name_padding = True, load_flow = False),
    dict(
