...
"""
load_from = "./workdirs/optical_flow_transformer/20210429_072707/checkpoints/epoch_3"
...
model = dict(
    ...
    generator=dict(
        ...
        do_not_attention = do_not_attention),
