...
"""
load_from = "./workdirs/MBRVSR_multilayer_highway_stage1/20210416_035902/checkpoints/epoch_4"
path2spynet = "./workdirs/spynet/spynet-sintel-final.mge"
dataroot = "/data/home/songtt/chenyuxiang/datasets/REDS/train"
exp_name = 'MBRVSR_multilayer_highway_stage2'
blocktype = "resblock"
samples_per_gpu = 5
...
learning_rate_per_batch = 0.5 * 1e-4
crop_size = 64
scale = 4
