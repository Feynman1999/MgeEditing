...
"""
load_from = "./workdirs/MBRVSR_baseline_stage1/20210415_161353/checkpoints/epoch_4"
path2spynet = "./workdirs/spynet/spynet-sintel-final.mge"
dataroot = "/work_base/datasets/REDS/train"
exp_name = 'MBRVSR_vizflow'
blocktype = "resblock"
samples_per_gpu = 1
...
train_cfg = dict(img_norm_cfg = img_norm_cfg, train_cfg = dict(use_highway = use_highway, use_flow_mask = use_flow_mask, use_gap = use_gap, viz_flow = viz_flow))
...
train_pipeline = [
    dict(type='GenerateFrameIndices', interval_list=[3], many2many = True, index_start = 0, name_padding = True, load_flow = False),
    dict(
