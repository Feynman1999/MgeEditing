...
"""
load_from = "./workdirs/sttn_mgtv_with_mask/20210610_012449/checkpoints/epoch_300"
dataroot = "/data/home/songtt/chenyuxiang/datasets/mgtv"
exp_name = 'sttn_mgtv_with_mask'
...
train_pipeline = [
    ...
    dict(type='GenerateContinuousOrDiscontinuousIndices', continuous_probability = 0.4, inputnums = input_nums), # should have frames_path
    dict(
