...
"""
load_from = None
dataroot = "xxxxxxxxx/MFT_Challenges/intermediary"
...
train_pipeline = [
    ...
    dict(
        ...
        key='img2',
        flag='color'),
    dict(type='ColorJitter', keys=['img1', 'img2'], brightness=0.4, contrast=0.6, saturation=0.0, hue=0.0),
